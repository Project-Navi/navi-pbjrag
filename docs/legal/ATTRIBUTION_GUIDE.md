...
**Waiver (if needed):** email `legal@projectnavi.ai` with reason (confidentiality/regulatory/white‑label). We’ll confirm in writing.

**Brand use:** The credit above is permitted. All other brand/trademark use requires our written consent.
