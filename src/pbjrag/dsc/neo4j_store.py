...
class DSCNeo4jStore:
    ...
    def __init__(
        ...
        if not actual_password:
            logger.error("Neo4j password not provided. Set NEO4J_PASSWORD environment variable or pass password parameter.")
            self.driver = None
            return
